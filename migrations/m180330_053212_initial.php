...
class m180330_053212_initial extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert('products', ['fid_category', 'title', 'description', 'img_path_full'], [
            ...
            [2, 'ПН 27*28', 'Профиль направляющий 27x28', 'hypocarton_profile/2.png'],
            [2, 'ПН 50*40', 'Профиль направляющий 50x40', 'hypocarton_profile/3.png'],
            [2, 'ПС 50*50', 'Профиль С-образный 50x40', 'hypocarton_profile/4.png'],
            [2, 'ПН 75*40', 'Профиль направляющий 75x40', 'hypocarton_profile/5.png'],
            [2, 'ПС 75*50', 'Профиль С-образный 75x50', 'hypocarton_profile/6.png'],
            [2, 'ПН 100*40', 'Профиль направляющий 100x40', 'hypocarton_profile/7.png'],
            [2, 'ПС 100*50', 'Профиль С-образный 100x50', 'hypocarton_profile/8.png'],
            ...
            [3, 'Крепежный уголок равносторонний KUR-60x60', 'Перфорированный крепежный равносторонний уголок KUR-60x60', 'fasteners/6.png'],
            [3, 'Уголок крепежный усиленный KUU-105x105', 'Перфорированный уголок крепежный усиленный KUU-105x105', 'fasteners/7.png'],
            [3, 'Уголок крепежный усиленный KUU-50x35', 'Перфорированный уголок крепежный усиленный KUU-50x35', 'fasteners/8.png'],
            [3, 'Уголок крепежный усиленный KUU-90x40', 'Перфорированный уголок крепежный усиленный KUU-90x40', 'fasteners/9.png'],
            [3, 'Пластина соединительная PS-40x160', 'Перфорированная соединительная пластина PS-40x160', 'fasteners/10.png'],
            [3, 'Пластина соединительная PS-80x240', 'Перфорированная соединительная пластина PS-80x240', 'fasteners/11.png'],
            [3, 'Пластина соединительная PS-60x300', 'Перфорированная соединительная пластина PS-60x300', 'fasteners/12.png'],

            [4, 'Анкерный подвес с зажимом', 'Анкерный подвес с зажимом', 'accessories/1.png'],
            [4, 'Тяга', 'Тяга', 'accessories/2.png'],
            [4, 'Соединитель одноуровневый "краб"', 'Соединитель одноуровневый "краб"', 'accessories/3.png'],
            ...
            [4, 'Подвес прямой', 'Подвес прямой', 'accessories/6.png'],
